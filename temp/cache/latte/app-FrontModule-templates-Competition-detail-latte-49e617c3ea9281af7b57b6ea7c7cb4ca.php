<?php
// source: C:\wamp\www\private\w-e-b-s\2014\Soccer\app\FrontModule/templates/Competition/detail.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4656990120', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb772127556c_title')) { function _lb772127556c_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbdb3b597e66_content')) { function _lbdb3b597e66_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>        <div class="row">
...
// block _competition
//
if (!function_exists($_b->blocks['_competition'][] = '_lbcdbe39ec58__competition')) { function _lbcdbe39ec58__competition($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('competition', FALSE)
